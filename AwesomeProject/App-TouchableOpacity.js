import { ActivityIndicator, ScrollView, StyleSheet, Text, View, FlatList, Alert, TouchableHighlight } from "react-native";
            ...
            return <View style={{ marginLeft: 50, marginTop: 50, padding: 10 }}>
                <FlatList
                    ...
                    renderItem={({ item }) => {
                        ...
                        //     {item.title}
                        // </Text>
                        return <TouchableHighlight activeOpacity={0.4} underlayColor='yellow' onPress={() => {
                            this.onSelectItem(item)
                        }}>
                            <View>
